...
public class ApplicationConfig extends Application {
    ...
    public Set<Class<?>> getClasses() {
        ...
        resources.add(fakefb.model.Friend.class);
        resources.add(fakefb.model.FriendEvent.class);
        resources.add(fakefb.model.FriendList.class);
    ...
    public Map<String, Object> getProperties() {
        ...
        //therefore we want to disable wadl (http://localhost:8080/service/application.wadl should return
        //   http 404)
